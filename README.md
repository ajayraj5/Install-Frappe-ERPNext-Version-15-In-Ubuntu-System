# Install-Frappe-ERPNext-Version-15-In-Ubuntu

A complete Guide to Install Frappe/ERPNext version 15  in Ubuntu
...
### STEP 15 install ERPNext latest version in bench & site (Skip this step if you don't want to install ERPNext)
